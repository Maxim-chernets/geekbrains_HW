...
VALUES
  ('Петр', 'Петров', NOW(), NOW()),
  ('Сергей', 'Сергеев', NOW(), NOW()),
  ('Алекс', 'Алеексов', NOW(), NOW()),
  ('Максим', 'Маскимов', NOW(), NOW());
...
VALUES
  (FLOOR(1 + RAND() * 8),FLOOR(1 + RAND() * 8), FLOOR(RAND() * 100), NOW(), NOW()),
  (FLOOR(1 + RAND() * 8),FLOOR(1 + RAND() * 8), FLOOR(RAND() * 100), NOW(), NOW()),
  (FLOOR(1 + RAND() * 8),FLOOR(1 + RAND() * 8), FLOOR(RAND() * 100), NOW(), NOW()),
  (FLOOR(1 + RAND() * 8),FLOOR(1 + RAND() * 8), FLOOR(RAND() * 100), NOW(), NOW()),
  (FLOOR(1 + RAND() * 8),FLOOR(1 + RAND() * 8), FLOOR(RAND() * 100), NOW(), NOW()),
...
SELECT DAYOFWEEK(CONCAT(year(NOW()), '-', month(birthday_at),'-', day(birthday_at))) AS day,
COUNT(*) AS counter
FROM users
GROUP BY day;
